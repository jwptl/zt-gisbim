<template>
      ...
      <el-col :span="18">
        <el-form :model="form" :inline="true">
          ...
          <el-form-item>
            ...
            <el-button v-auth="['manage:add']" type="primary" :color="'#48C684'" style="color: #FFFFFF" @click="openModal">
              <el-icon>
                <Plus/>
              </el-icon>
              新增指标
    ...
    <div class="echarts-list">
      <div class="echarts-item" v-for="(item) in componentList" :key="item.id">
        <div class="content">
          <div class="editbtn" v-auth="['manage:edit']" @click="onEdit(item)">
          ...
          >
            <template #reference>
              <div class="delebtn"  v-auth="['manage:delete']">
